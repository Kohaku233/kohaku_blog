      ...
      <div className="bg-gradient-to-br from-purple-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        <header className="container mx-auto px-4 py-6">
          <nav className="flex items-center justify-between relative">
            <Link href="/">
              <span className="text-2xl font-bold text-gray-800 dark:text-white">H</span>
            </Link>
            <div className="hidden md:flex items-center space-x-4">
              <Link href="/blog" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                Blog
              </Link>
              <Link href="/guestbook" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                Guestbook
              </Link>
              ...
              <Link href="/uses" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">
                Uses
              </Link>
            </div>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {isMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-1 z-10">
                    ...
                    <Link href="/guestbook" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                      Guestbook
                    </Link>
                    ...
                    <Link href="/uses" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                      Uses
                    </Link>
                  </div>
                )}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-2/3">
              <h1 className="text-4xl md:text-6xl font-bold mb-4 text-gray-900 dark:text-white">
                I&apos;m Hong, a Full Stack Developer
              </h1>
              <p className="text-2xl md:text-4xl mb-4 text-gray-800 dark:text-gray-200">
                creating <span className="text-orange-500">amazing</span> websites using
              </p>
              <p className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white">React.</p>
              <p className="text-gray-600 dark:text-gray-400 mt-4">Hong Kong • UTC/GMT +8</p>
            </div>
